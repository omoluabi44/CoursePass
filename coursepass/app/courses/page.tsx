...
<div className={s.container}>
  <aside id={s.sidebar}>
    <ul>
      <li>
        <span className={s.logo}>CoursePass</span>
        <button id={s.togglebtn}> 
        <svg 
        className={s.svg}
  ...
  <main>
    ...
    <p>
      ...
      euismod, tincidunt enim sit amet, lacinia purus. In hac habitasse platea
      dictumst. Suspendisse potenti. Nullam euismod, arcu nec fermentum
      fermentum, purus ex tincidunt ex, nec fermentum justo felis sit amet
      turpis. Sed sed
    </p>
    <p>
      Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed ac nunc
